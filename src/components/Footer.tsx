const footerLinks = {
  ...
  Resources: ["Community", "Help Center", "Status", "Templates", "Tutorials"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 mb-4">Build faster. Ship smarter.</p>
            <div className="flex gap-3">
              {socials.map((s) => (
                <a key={s.name} href={s.href} className="text-gray-500 hover:text-white transition-colors">
                  {s.icon}
                </a>
              ))}
            </div>
        ...
        <div className="pt-8 border-t border-[#1e293b] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">© 2026 Nexus. All rights reserved.</p>
